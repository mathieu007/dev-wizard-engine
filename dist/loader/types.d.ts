...
export type DevWizardStep = PromptStep | CommandStep | MessageStep | BranchStep | GroupStep | IterateStep | ComputeStep | GitWorktreeGuardStep | PluginStep;
export declare const BUILTIN_STEP_TYPES: readonly ["prompt", "command", "message", "branch", "group", "iterate", "compute", "git-worktree-guard"];
...
export type PromptDynamicOptions = PromptCommandOptions | PromptGlobOptions | PromptJsonOptions | PromptWorkspaceProjectsOptions | PromptProjectTsconfigsOptions;
export interface PromptDynamicBase {
    cache?: "session" | "always" | {
        ttlMs: number;
    };
