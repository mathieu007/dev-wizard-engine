...
describe("projects orchestrator helpers", () => {
	test("createProjectsOrchestratorOptions merges overrides", async () => {
		const options = await createProjectsOrchestratorOptions({
			configPath: "/repo/node_modules/@ScaffoldStack/dev-wizard-presets/projects/index.yaml",
		...
		expect(options.configPath).toBe("/repo/node_modules/@ScaffoldStack/dev-wizard-presets/projects/index.yaml");
...
describe("maintenance helpers", () => {
	test("createMaintenanceOptions merges overrides", async () => {
		const options = await createMaintenanceOptions({
			configPath: "/repo/node_modules/@ScaffoldStack/dev-wizard-presets/maintenance/index.yaml",
			overrides: {
		...
		expect(options.configPath).toBe(
			"/repo/node_modules/@ScaffoldStack/dev-wizard-presets/maintenance/index.yaml",
		);
